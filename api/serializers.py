...
class FilmListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Film
        fields = (
            'title', 'description', 'release_data', 'run_time', 'budget',
            'usa_gross', 'world_gross', 'oscar_awards', 'poster',
        )
...
class CommentToFilmSerializer(serializers.ModelSerializer):
    ...
    Also it adds new comment to movie.
    It is connected with 'CommentToFilm' model.
    """
    class Meta:
        model = CommentToFilm
...
class NewsListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = News
        fields = (
            'title', 'description', 'created_at', 'news_source',
...
class CommentToNewsSerializer(serializers.ModelSerializer):
    ...
    Also it adds new comment to cinema news.
    It is connected with 'CommentToNews' model.
    """
    class Meta:
        model = CommentToNews
...
class CinemaPersonDetailSerializer(serializers.ModelSerializer):
    """
    Serializer for getting of some data of cinema person selected by visitor.
    ...
    class Meta:
        model = CinemaPerson
        fields = (
            'fullname', 'gender', 'birthday', 'bio', 'oscar_awards', 'avatar',
        )
...
class CommentToPersonSerializer(serializers.ModelSerializer):
    ...
    Also it adds new comment to cinema person.
    It is connected with 'CommentToPerson' model.
    """
    class Meta:
