...
class CountryAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'Country' model view in interface of admin site
    Django.
    """
...
class GenreAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'Genre' model view in interface of admin site
    Django.
    """
...
class LanguageAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'Language' model view in interface of admin site
    Django.
    """
...
class DistributorAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'Distributor' model view in interface of admin
    site Django.
    """
...
class ImdbRatingAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'ImdbRating' model view in interface of admin site
    Django.
    """
...
class MpaaRatingAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'MpaaRating' model view in interface of admin site
    Django.
    """
...
class CinemaFilmPersonProfessionInline(admin.TabularInline):
    ...
    Add related records of 'CinemaFilmPersonProfession' model to web
    page display / edit of 'Film' model in interface of admin site
    Django.
    """
...
class FilmAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'Film' model view in interface of admin site
    Django.
    """
    ...
    fieldsets = (
        ...
        ("IMDb Box Office", {"fields": ("budget", "usa_gross", "world_gross")}),
        ("Wiki", {"fields": ("description", "oscar_awards", "distributor")}),
        ("Media", {"fields": ("poster",)}),
    )
...
class CinemaPersonAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'CinemaPerson' model view in interface of admin
    site Django.
    """

    list_display = ("fullname", "gender", "country", "birthday", "oscar_awards")
...
class CinemaProfessionAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'CinemaProfession' model view in interface of
    admin site Django.
    """
...
class CinemaFilmPersonProfessionAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'CinemaFilmPersonProfession' model view in
    interface of admin site Django.
    """
...
class ProductAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'Product' model view in interface of admin site
    Django.
    """
...
class NewsAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'News' model view in interface of admin site
    Django.
    """
    ...
    fieldsets = (
        ("Main", {"fields": ("title", "description", "created_at")}),
        ("Source Details", {"fields": ("news_source", "news_author")}),
        ("Related Info", {"fields": ("film", "cinema_person")}),
        ("Media", {"fields": ("news_feed_photo", "news_detail_photo")}),
    )
    date_hierarchy = "created_at"
    readonly_fields = ("created_at",)
...
class CommentToPersonAdmin(admin.ModelAdmin):
    ...
    Set parameters of 'CommentToPerson' model view in interface of admin
    site Django.
    """
...
class CommentToFilmAdmin(CommentToPersonAdmin):
    ...
    Set parameters of 'CommentToFilm' model view in interface of admin
    site Django.
    """

    list_display = ("author", "content", "created_at", "is_active", "film")
...
class CommentToNewsAdmin(CommentToPersonAdmin):
    ...
    Set parameters of 'CommentToNews' model view in interface of admin
    site Django.
    """

    list_display = ("author", "content", "created_at", "is_active", "news")
...
class CommentToProductAdmin(CommentToPersonAdmin):
    ...
    Set parameters of 'CommentToProduct' model view in interface of
    admin site Django.
    """

    list_display = ("author", "content", "created_at", "is_active", "product")
